...
# ================= 1. 核心配置区 =================
IMAGE_DIR = "Abed"             # 你的图片文件夹 (请改成你当前爬取的椅子文件夹)
OUTPUT_LABEL_DIR = "Abed_clean" # 生成的纯净 YOLO 标签保存路径

# 🌟 强调整体，同时加入柜子/茶几等作为“语义避雷针”
TEXT_PROMPT = "a complete chair . the whole sofa . an entire armchair . a complete recliner . a cabinet . a coffee table . a plant ."
TARGET_KEYWORDS = ["chair", "sofa", "armchair", "recliner"] # 我们真正想要的关键词

CLASS_ID = 0                     # YOLO 类别 ID (请根据你的 dataset.yaml 修改，椅子通常是2)

BOX_THRESHOLD = 0.3              # 框置信度
TEXT_THRESHOLD = 0.3             # 文本匹配度

# 🌟 内置的 C位清洗阈值
INTERNAL_IOA_THRESH = 0.60       # 内部碎渣判定：60% 面积在主框内部，删！
EXTERNAL_AREA_RATIO = 0.35       # 外部垃圾判定：面积小于主框的 35% 且不重合，删！
